...
public class SMTDenyUnlessPermit extends SMTCombiningAlg implements ISMTCombAlg {
	public SMTDenyUnlessPermit(SMTPolicyElement[] eList, Context con, int v) {
	...
	public void runv3Rule(String id, SMTRule r1, SMTRule r2, Context ctx, boolean withDetails) {
		try {
			...
			Pair<BoolExpr, BoolExpr> c_d_temp = and(allRequests, not(c_p_temp));
...
/* Location:              /Users/okielabackend/Downloads/XACMLSMT.jar!/combiningalg/SMTDenyUnlessPermit.class
